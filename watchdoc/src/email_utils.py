...
def create_message(to, link):
    ...
    message = MIMEText(
        ...
        "<li>В карточке для выбора физ. упражнения укажите ваши ФИО, в графе «Факультет» "
        "укажите название вашего факультета в формате «компьютерных наук» (без кавычек), "
        "напротив поля «д.р, возраст» укажите вашу дату рождения и ваш возраст "
        "(например, 01.07.2003 (21 год)). Далее выберите одно упражнение из каждой категории и "
        "подчеркните его.</li>\n"
