...
from herokuapp.views import keywords_search, login, info, logout, documents, nir, subjects, educational_materials, authors, \
    published_places
...
urlpatterns = [
    ...
    path('api/keywords_search', keywords_search),
]
