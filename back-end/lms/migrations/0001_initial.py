# Generated by Django 3.1.5 on 2021-01-15 07:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson_type', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='lms.lessontype')),
                ('milgroup', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='lms.milgroup')),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='lms.room')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='common.subject')),
            ],
            options={
                'verbose_name': 'Lesson',
