# Generated by Django 3.1.5 on 2021-03-15 12:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Status',
            fields=[
                ('status', models.CharField(choices=[('student', 'обучающийся'), ('graduated', 'выпускник'), ('deducted', 'отчислен'), ('enrollee', 'абитуриент')], max_length=20, primary_key=True, serialize=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pers_email', models.EmailField(blank=True, max_length=254)),
                ...
                ('mil_specialty', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='lms.milspecialty')),
                ...
                ('photo', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='common.personphoto')),
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='lms.program')),
                ('recruitment_office', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='lms.recruitmentoffice')),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='lms.status')),
                ('university_info', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='lms.universityinfo')),
            ],
            options={
