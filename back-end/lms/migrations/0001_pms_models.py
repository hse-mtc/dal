...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='MilSpecialty',
            fields=[
                ('mil_specialty', models.CharField(max_length=20, primary_key=True, serialize=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(max_length=128, upload_to='')),
                ...
                ('brothers', models.ManyToManyField(related_name='brothers', to='common.Relative')),
                ('father', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='father', to='common.relative')),
                ...
                ('mother', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='mother', to='common.relative')),
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='lms.program')),
                ('sisters', models.ManyToManyField(related_name='sisters', to='common.Relative')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mark', models.PositiveSmallIntegerField(validators=[django.core.validators.MaxValueValidator(10), django.core.validators.MinValueValidator(0)])),
