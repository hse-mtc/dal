# Generated by Django 3.1.5 on 2021-03-05 10:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(max_length=128, upload_to=common.models.persons.upload_to_)),
                ...
                ('brothers', models.ManyToManyField(blank=True, null=True, related_name='brothers', to='common.Relative')),
                ...
                ('sisters', models.ManyToManyField(blank=True, null=True, related_name='sisters', to='common.Relative')),
