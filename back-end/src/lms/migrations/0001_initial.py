# Generated by Django 3.2.10 on 2022-02-09 10:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_info', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.RESTRICT, to='common.birthinfo')),
                ...
                ('passport', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.RESTRICT, to='common.passport')),
                ('photo', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='common.photo')),
                ('skills', models.ManyToManyField(blank=True, to='lms.Skill')),
                ('university_info', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.RESTRICT, to='common.universityinfo')),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
