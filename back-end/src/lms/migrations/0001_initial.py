    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weekday', models.DecimalField(blank=True, decimal_places=0, max_digits=1, null=True)),
                ('milfaculty', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='lms.milfaculty')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surname_genitive', models.CharField(blank=True, max_length=32)),
                ('name_genitive', models.CharField(blank=True, max_length=32)),
                ...
                ('rank', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='lms.rank')),
                ('teacher_post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='lms.teacherpost')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('milgroup', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='lms.milgroup')),
                ('milspecialty', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='lms.milspecialty')),
                ('passport', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='lms.passport')),
                ('photo', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='common.photo')),
