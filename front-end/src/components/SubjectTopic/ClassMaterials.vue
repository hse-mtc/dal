  ...
  <div class="class-materials file-group">
    ...
    <div style="display: none">
        ...
        <div class="file" v-for="(material, index) in materials" :key="index">
          ...
          <div class="file-kebab">
            <el-popover placement="bottom" trigger="click">
              ...
              >
                <div v-if="isOwner" style="cursor: pointer" @click="deleteMaterial(material.id)">Удалить</div>
      ...
      <div v-else class="pt-2 pl-2">
        <CustomText v-if="!isOwner" variant="paragraph">Здесь пока нет материалов</CustomText>
      </div>
      <CustomText
          v-if="isOwner"
          class="mt-3 mb-1"
          variant="paragraph"
          color="#0C4B9A"
          :custom-style="{ cursor: 'pointer', display: 'flex', justifyContent: 'center'}">
