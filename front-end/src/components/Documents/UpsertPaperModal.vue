<template>
  <div class="addModal">
    <ElForm ref="paperForm" :model="paperForm" :rules="rules" label-width="180px">
      ...
      <ElFormItem label="Файл" prop="files">
        ...
        >
          <ElButton v-if="!paperForm.files.length" slot="trigger" size="small" type="primary">
            Загрузить...
          </ElButton>
        </ElUpload>
      </ElFormItem>
      ...
      <ElFormItem>
        <ElButton type="primary" @click="submitForm('paperForm')">Отправить</ElButton>
