...
<script>
import { getMilgroups, getRanks, getSkills, getPosts } from '@/api/referencebook'
...
export default {
    ...
    methods: {
        ...
        handleInputConfirm(item){
            ...
            if (item.inputValue)
                item.names.push(item.inputValue);
            item.inputVisible = false;
        ...
        fetchData(){
            ...
            .catch(() => {
                this.$message({ message: 'Ошибка получения списка взводов!', type: 'error' });
            });
