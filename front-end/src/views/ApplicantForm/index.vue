      ...
      if (this.validate()) {
        ...
        reader.onload = async () => {
          ...
          try {
            ...
            this.$alert(
              "Проверьте правильность заполненных данных, если ошибка не уйдет, отправьте текст ошибки нам на почту: <a href=\"mailto:dal.mec.hse@gmail.com\">dal.mec.hse@gmail.com</a>",
