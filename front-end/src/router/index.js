        ...
        children: [
            {
                ...
                meta: {title: "Мои материалы", icon: "dashboard"},
            },
        ],
    },
        ...
        children: [
            {
                ...
                meta: {title: "Военно-научные работы", icon: "dashboard"},
            },
        ],
    },
    {
        ...
        children: [
            {
                ...
                meta: {title: "Учебно-методические материалы", icon: "dashboard"},
            },
            {
        ...
        children: [
            {
                ...
                meta: {title: "Электронная библиотека", icon: "dashboard"},
            },
            {
                path: "book/:id",
                name: "Book",
        ...
        children: [
            {
                ...
                meta: {title: "Личный состав ВУЦ", icon: "dashboard"},
            },
        ],
    },
        ...
        children: [
            {
                ...
                meta: {title: "Журнал посещаемости", icon: "dashboard"},
            },
        ],
    },
        ...
        children: [
            {
                ...
                meta: {title: "Дисциплинарный журнал", icon: "dashboard"},
            },
        ],
    },
    ...
    children: [
      {
        ...
        meta: { title: "Расписание занятий", icon: "dashboard" },
      },
    ],
  },
